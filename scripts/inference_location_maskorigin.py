...
def get_inputs(testdir, turn, root_path="/workdir/radish/hachi/OBJ_INS/phase2_V2"):
    inputs = []
    ...
    for file in tqdm(os.listdir(anno_class_test_path)):
        ...
        exam_mask_path = anno_folder_path.replace("annotation.json", f'mask_{turn_i+1}.png')
