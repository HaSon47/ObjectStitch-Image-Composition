...
# --outdir /workdir/radish/hachi/Output/Location_phase1_remove/ObjStit_Finetune \
...
python scripts/inference_real_remove.py \
--outdir /workdir/radish/hachi/Output/Location_real_remove/ObjStit_Finetune_pad15/easy \
--testdir /workdir/radish/hachi/OBJ_INS/Real/Real_easy \
--locationdir /workdir/radish/hachi/Data/box_results/easy \
--ckpt_dir ./checkpoints \
--ckpt_objstit /workdir/radish/hachi/Output/experiments/objectstitch_15k_mix2/2026-02-27T08-43-50/checkpoints/epoch=000012.ckpt \
--num_samples 3 \
--sample_steps 45 \
